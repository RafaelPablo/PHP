...
<body>
  ...
  <p style="text-align:center;color:white">Create a secretary account</p>
  <div class="container-sm">
    <form method="post" action="../Controller/registerAccountSecreatry.php" id="formCreateAccount">
